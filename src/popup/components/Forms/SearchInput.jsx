...
const SearchBox = () => {
    ...
    return (
        <div className="relative flex h-full items-center 
                        px-6">
            <input type="search" placeholder="Search for friends or players" className={`bg-globalBgColor  border-[1.2px] rounded-[15px] focus:border-[#29B080]
                                                                px-[16px] py-[11px] text-[#929298] text-base w-full ${typing ? 'border-[#29B080]' : 'border-[#272829]'}`} onChange={(e) => { e.target.value !== '' ? setTyping(true) : setTyping(false) }} />
